...
package de.bushnaq.abdalla.pluvia.scene.model;
 ...
 * @author kunterbunt
 */
public abstract class AbstractActor extends Renderable<GameEngine> {
    ...
    public    Vector3     position;//position of actor
    protected float       size;
    public    Vector3     speed                             = new Vector3(0, 0, 0);//speed of actor
    ...
    public AbstractActor(RenderEngine3D<GameEngine> renderEngine, int type, float size, BoundingBox cage) {
        this.type = type;
        this.size = size;
        this.cage = cage;
